...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-zinc-950 pt-24 pb-8 border-t border-white/5 relative">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-12 md:gap-8 mb-20">
          ...
          <div className="flex flex-col items-start">
            <Link href="/" className="text-2xl font-playfair font-bold text-white tracking-widest mb-6 hover:text-zinc-300 transition-colors inline-block">
              ALPEREN BÖRKLÜ
            </Link>
            ...
            <a href="mailto:hello@alperenborklu.com" className="text-sm font-medium text-white underline underline-offset-8 decoration-white/30 hover:decoration-white transition-all">
            ...
            <nav className="flex flex-col space-y-4">
              {['Work', 'About', 'Pricing', 'Blog', 'Resume'].map((item) => (
                <Link 
                  ...
                  className="text-zinc-400 hover:text-white text-sm font-light transition-colors w-max"
                >
                  {item}
                </Link>
              ))}
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col space-y-4">
              ...
              {/* Instagram */}
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 text-zinc-400 hover:text-white transition-colors w-max">
              ...
              {/* LinkedIn */}
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 text-zinc-400 hover:text-white transition-colors w-max">
                <svg className="w-[18px] h-[18px] opacity-70 group-hover:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Vimeo */}
              <a href="https://vimeo.com" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 text-zinc-400 hover:text-white transition-colors w-max">
                <svg className="w-[18px] h-[18px] opacity-70 group-hover:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* YouTube (Yeni Eklendi) */}
              <a href="https://youtube.com/@seninkanalin" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 text-zinc-400 hover:text-white transition-colors w-max">
                <svg className="w-[18px] h-[18px] opacity-70 group-hover:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Alt Kısım: Telif Hakkı ve İnce Detaylar */}
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] tracking-[0.2em] uppercase text-zinc-600 font-medium">
