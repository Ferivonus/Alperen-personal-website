...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#080808] pt-24 pb-8 border-t border-white/5 relative">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-px bg-linear-to-r from-transparent via-[#c0a062]/20 to-transparent"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-12 md:gap-8 mb-20">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col space-y-4">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/alperenbarkley/" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 text-zinc-400 hover:text-[#c0a062] transition-colors w-max">
                <svg className="w-4.5 h-4.5 opacity-70 group-hover:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/alperen-b%C3%B6rkl%C3%BC-47198112a/" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 text-zinc-400 hover:text-[#c0a062] transition-colors w-max">
                <svg className="w-4.5 h-4.5 opacity-70 group-hover:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/@alperenborklu4005" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 text-zinc-400 hover:text-[#c0a062] transition-colors w-max">
                <svg className="w-4.5 h-4.5 opacity-70 group-hover:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 24 24">
